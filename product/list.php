            ...
            <section class="best">
                ...
                <div class="best1" onclick="location.href='best01.php'">
                    <a href="best01.php"></a>
                        ...
                        <p class="cont1"><?php echo $array["com"]; ?></p>
                        <p class="cont2"><span class="txt_sale"><?php echo $array["per"]; ?></span> <span class="txt_price"><?php echo $array["s_price"]; ?></span> <span class="txt_price_ins">36,000원</span></p>
                </div>
                <div class="best2">
                    <a href="#"></a>
                    <h3>일반 관람권</h3>
